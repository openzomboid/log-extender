...
function VehicleClientLogger.IsEnabledOnServer()
...
VehicleClientLogger.VehicleEnter = function(player)
    if player and instanceof(player, 'IsoPlayer') and player:isLocalPlayer() then
        if VehicleClientLogger.vehicle == nil then
...
VehicleClientLogger.DebugContextMenuCheats = function()
...
if VehicleClientLogger.IsEnabledOnServer() then
...
if SandboxVars.LogExtender.VehicleAdminTools then
    ...
    VehicleClientLogger.DebugContextMenuCheats()
