...
function PlayerClientLogger.IsEnabledOnServer()
...
PlayerClientLogger.OnGameStart = function()
    local levelup = PlayerClientLogger.IsEnabledOnServer()
    local tick = PlayerClientLogger.IsEnabledOnServer()
    local death = PlayerClientLogger.IsEnabledOnServer()
...
if PlayerClientLogger.IsEnabledOnServer() then
